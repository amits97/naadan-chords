    ...
    if (this.props.isEmbed) {
      return (
        <div>
          ...
          <ul>
            <li>
              <a href="/request">Click here</a> to submit a request for the song
              you are looking for - it will only take a second.
            </li>
            <li>
              If you think there is something wrong, please{" "}
              <a
